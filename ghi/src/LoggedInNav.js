    ...
    return (
        <nav className="navbar navbar-expand-lg flex justify-between items-center w-full" style={{ backgroundColor: 'rgba(200, 75, 150, 102)' }}>
            <div className="container-fluid mx-auto px-0 justify-between">
                ...
                <div className="flex space-x-4">
                    <NavLink to="/potentialmatch" className="text-white text-base font-bold px-4 py-2 hover:bg-pink-600 rounded flex items-center">
                ...
                <div className="flex space-x-4">
                    <NavLink to="/profile" className="text-white text-base font-bold px-4 py-2 hover:bg-pink-600 rounded flex items-center">
